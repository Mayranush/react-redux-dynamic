              ...
              <div className="form-group">
                ...
                <div className="col-lg-3 form-group-values tw-crit">
                  <input id="consumerKey" ref="consumerKey" className="form-control" type="text"
                         defaultValue={this.props.twitter.consumerKey} placeholder={this.props.twitter.consumerKey}/>
                </div>
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <div className="col-lg-3 form-group-values tw-crit">
                  <input id="accessToken" ref="accessToken" className="form-control" type="text"
                         defaultValue={this.props.twitter.accessToken} placeholder={this.props.twitter.accessToken}/>
                </div>
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <div className="col-lg-3 form-group-values tw-crit">
                  <input id="minFollowers" ref="minFollowers" className="form-control" type="text"
                         defaultValue={this.props.twitter.minFollowers} placeholder={this.props.twitter.minFollowers}/>
                </div>
              </div>
              <div className="form-group">
                ...
                <div className="col-lg-3 form-group-values tw-crit">
                  <input id="tipsPerDay" ref="tipsPerDay" className="form-control" type="text"
                         defaultValue={this.props.twitter.tipsPerDay} placeholder={this.props.twitter.tipsPerDay}/>
                </div>
              </div>

              <div className="checkbox">
                <label><input type="checkbox" ref="tipsLike"  defaultChecked={this.props.twitter.tipsLike}
                              placeholder={this.props.twitter.tipsLike}/> Like</label>
              </div>
              <div className="checkbox">
                <label><input type="checkbox" ref="tipsTweet"  defaultChecked={this.props.twitter.tipsTweet}
                              placeholder={this.props.twitter.tipsTweet}/> Tweet</label>
              </div>
              <div className="checkbox">
                <label><input type="checkbox" ref="tipsReTweet"  defaultChecked={this.props.twitter.tipsReTweet}
                              placeholder={this.props.twitter.tipsReTweet}/> ReTweet</label>
              </div>
              <div className="checkbox">
                <label><input type="checkbox" ref="tipsFollowers" defaultChecked={this.props.twitter.tipsFollowers}
                              placeholder={this.props.twitter.tipsFollowers}/> is Follower</label>
              </div>
            </div>
          </div>
        </form>
