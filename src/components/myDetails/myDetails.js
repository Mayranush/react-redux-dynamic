        ...
        <form className="form-horizontal" role="form">
          <div className="form-group">
            ...
            <div className="col-lg-3 form-group-values-my-details">
              <input id="first_name" className="form-control" type="text" defaultValue={this.props.user.firstName} placeholder={this.props.user.firstName} ref="firstName"/>
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-lg-3 form-group-values-my-details">
              <input id="last_name" className="form-control" type="text" defaultValue={this.props.user.lastName} placeholder={this.props.user.lastName} ref="lastName"/>
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-lg-3 form-group-values-my-details">
              <input id="user_email" className="form-control" type="text" defaultValue={this.props.user.email} placeholder={this.props.user.email} ref="email"/>
            </div>
          </div>
          <div className="form-group">
            <label htmlFor="position" className="col-lg-3 control-label">Twitter Username</label>
            <div className="col-lg-3 form-group-values-my-details">
              <input id="position" className="form-control" type="text" defaultValue={this.props.user.twUsername} placeholder={this.props.user.twUsername} ref="twUsername"/>
            </div>
          </div>
        </form>
        <div>
