        ...
        <form className="form-horizontal" role="form">
          <div className="form-group">
            ...
            <div className="col-lg-3 form-group-values">
              <input id="first_name" className="form-control" type="text" value="Nick"/>
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-lg-3 form-group-values">
              <input id="user_email" className="form-control" type="text" value="nickBishop@gmail.com"/>
            </div>
          </div>
          <div className="form-group">
            <label htmlFor="position" className="col-lg-3 control-label">Phone number</label>
            <div className="col-lg-3 form-group-values">
              <input id="position" className="form-control" type="text" value="1684313554541"/>
            </div>
          </div>
        </form>
        <br/>
