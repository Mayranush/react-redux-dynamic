...
export default handleActions({
  ...
  [ActionTypes.getDataResponseTwitterCriteria]: (state, {payload}) => ({
    ...state,
  ...
  [ActionTypes.getDataResponseTwitterSettingsUpdate]: (state, {payload}) => ({
    ...state,
  ...
  [ActionTypes.getDataResponseTwitterCriteriaUpdate]: (state, {payload}) => ({
    ...state,
  ...
  [ActionTypes.getDataResponseBotGet]: (state, {payload}) => ({...state, botStatus: payload.botStatus}),

  [ActionTypes.getDataRequestBotPost]: (state) => ({...state}),
  [ActionTypes.getDataResponseBotPost]: (state, {payload}) => ({
    ...state,
    botStart: payload.botStart,
